...
describe("<InfoCards />", () => {
  ...
  function shallowWithPage(page: ObjectsPage<TestInstance>) {
    testModelInstanceService = mockModelInstanceService<TestInstance>(
      undefined,
      page
    );
  ...
  function createTestPage(
    num_objects: number = 0,
    total_results: number = 0,
    pageNumber: number = 1
  ): ObjectsPage<TestInstance> {
  ...
  function createTestState(
    pageNumber: number = 1,
    page: ObjectsPage<TestInstance> = createTestPage(),
