...
describe("GuiTests", () => {
  ...
  it("should have adoption link", async () => {
    await driver.get(base_url);
    await driver.sleep(1500);
    const adoption_link = (await driver).findElement(
      By.linkText("adopt a pet today")
    );
    adoption_link.click();
    await driver.sleep(1500);
    const current_url = (await driver)
      .getCurrentUrl()
      .then((value) => expect(value).to.include(base_url + "pets/"));
  });
  ...
  it("should navigate to dog breeds homepage", async () => {
    ...
    const current_url = (await driver)
      .getCurrentUrl()
      .then((value) => expect(value).to.include(base_url + "dog-breeds"));
  });
  ...
  it("should navigate to cat breeds homepage", async () => {
    ...
    const current_url = (await driver)
      .getCurrentUrl()
      .then((value) => expect(value).to.include(base_url + "cat-breeds"));
  });
  ...
  it("should navigate to shelters homepage", async () => {
    ...
    const current_url = (await driver)
      .getCurrentUrl()
      .then((value) => expect(value).to.include(base_url + "shelters"));
  });
  ...
  it("should navigate to about page", async () => {
    ...
    const current_url = (await driver)
      .getCurrentUrl()
      .then((value) => expect(value).to.include(base_url + "about"));
  });
  ...
  it("should search pets for query", async () => {
    await driver.get(base_url);
    await driver.sleep(1500);
    const search_dropdown = (await driver).findElement(
      By.id("search-bar-select")
    );
    search_dropdown.click();
    const select_items = (await driver).findElements(
      By.className("select-option")
    );
