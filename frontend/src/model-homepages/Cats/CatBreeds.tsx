...
interface CatBreedsProviders {
  catBreedsFilterOptionsService: FilterOptionsService<CatBreedsFilterOptions>;
}

export class CatBreeds extends React.Component<
  RouteComponentProps,
  CatBreedsState
> {
  static providers: CatBreedsProviders = {
    catBreedsFilterOptionsService: Pets4meCatBreedsFilterOptionsService,
  };
  ...
  componentDidMount() {
    let catBreedsFilterOptionsService =
      CatBreeds.providers.catBreedsFilterOptionsService;
    this.handleFilterUpdate = this.handleFilterUpdate.bind(this);
    catBreedsFilterOptionsService
      .getFilterOptions()
      .then((response: any) => {
