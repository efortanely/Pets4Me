    ...
    return (
      <div className="filters">
        ...
        <ThemeProvider theme={sliderTheme}>
          <h5>Height (in.)</h5>
          <Slider
            defaultValue={[this.props.min_height, this.props.max_height]}
            valueLabelDisplay="auto"
            min={this.props.min_height}
            max={this.props.max_height}
          ...
          <h5>Weight (lb.)</h5>
          <Slider
            defaultValue={[this.props.min_weight, this.props.max_weight]}
            valueLabelDisplay="auto"
            min={this.props.min_weight}
            max={this.props.max_weight}
            onChange={(event: any, value: any) =>
          ...
          <Slider
            ...
            valueLabelDisplay="auto"
            min={this.props.lifespan_min}
            max={this.props.lifespan_max}
            onChange={(event: any, value: any) =>
