...
interface PetsProviders {
  filterOptionsService: FilterOptionsService<PetsFilterOptions>;
}

export class Pets extends React.Component<RouteComponentProps, PetsState> {
  static providers: PetsProviders = {
    filterOptionsService: Pets4mePetsFilterOptionsService,
  };
  ...
  componentDidMount() {
    const filterOptionsService: FilterOptionsService<PetsFilterOptions> =
      Pets.providers.filterOptionsService;
    this.handleFilterUpdate = this.handleFilterUpdate.bind(this);
